import { parseWorkoutFromRawText } from '../workoutExtractorOCR';

describe('workoutExtractorOCR', () => {
...
8 | + | 25 | 11/16/25`,
                expected: {
                    title: 'AMRAP 10 min',
                    description: 'A brutal AMRAP with Double Unders and Bike.',
                    workout: [
                        {
                            type: 'movement',
                            movement: {
...
11/19/23 | 7:54 |`,
                expected: {
                    title: 'for time',
                    description: 'A For Time that pushed the limits with Wall Ball and Bjo.',
                    workout: [
                        {
                            type: 'movement',
                            movement: {
...
4:09 |`,
                expected: {
                    title: 'ESMOM',
                    description: 'A Unknown with Rmu and Wall Ball.',
                    workout: [
                        {
                            type: 'movement',
                            movement: {
...
24 | BJO | 30"`,
                expected: {
                    title: '3rds',
                    description: 'A Unknown with Cal Row and Toes-to-Bar.',
                    workout: [
                        {
                            type: 'movement',
                            movement: {
